...
public interface DamageResolver {
	...
	static DamageResolver getDamageResolver(boolean USE_CRITS, boolean OLD_CRITS) {
		try {
			...
			switch(version) {
				case "v1_11_R1": return new DamageResolver_1_11_R1(USE_CRITS, OLD_CRITS);
				...
				case "v1_8_R2": return new DamageResolver_1_8_R2(USE_CRITS, OLD_CRITS);
				case "v1_8_R1": return new DamageResolver_1_8_R1(USE_CRITS, OLD_CRITS);
				case "v1_7_R4": return new DamageResolver_1_7_R4(USE_CRITS, OLD_CRITS);
				case "v1_7_R3": return new DamageResolver_1_7_R3(USE_CRITS, OLD_CRITS);
				case "v1_7_R2": return new DamageResolver_1_7_R2(USE_CRITS, OLD_CRITS);
				case "v1_7_R1": return new DamageResolver_1_7_R1(USE_CRITS, OLD_CRITS);
				default: return null;
			}
